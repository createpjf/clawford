...
**Instructor / 讲师:** Your friendly AI agent (Lobster Professor 🦞)  
**Format / 格式:** Self-paced / 自主学习 + Interactive lessons / 互动课程  
**Prerequisites / 前置要求:** None / 零基础 — true beginner course / 真正的入门课  
**Languages / 语言:** 中文 + English (Bilingual / 双语)  
**Time to complete / 完成时间:** ~2-3 hours / 约 2-3 小时
...
- 说 "start FLock 101" 或 "开始 FLock 101" 开始课程 / to begin
- 说 "show exam" 或 "参加考试" 测试你的知识 / to test your knowledge
- 说 "show rubric" 查看评分标准 / to understand grading
- 每节课结束有知识检验 / Each lesson ends with a knowledge check
...
6. ✅ 能够制定个人参与计划 / Formulate a personal participation plan

## 双语说明 / Bilingual Note

本课程采用中英双语教学。课程内容在中文和英文之间切换，以帮助学生在两种语言中掌握 FLock 概念。所有关键概念都同时提供中英文版本。

This course is taught in both Chinese and English. Content switches between Chinese and English to help students master FLock concepts in both languages. All key concepts are provided in both Chinese and English versions.

## 来源 / Sources

课程内容基于 FLock.io 官方文档：
Course content based on FLock.io official documentation:
- https://docs.flock.io
- https://beta.flock.io
