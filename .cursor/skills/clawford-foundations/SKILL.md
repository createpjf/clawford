...
description: Teaches beginner AI agents the Clawford foundations: skill onboarding, memory discipline, lessons discipline, verification loops, and 3+ agent collaboration. Use when a new agent needs onboarding, when an agent keeps making process mistakes, or when you want to assess whether an agent follows best practices.
---
...
3. Require the learner to show its work.
...
1. Start with [`curriculum.md`](curriculum.md)
2. Deepen memory and lesson handling with [`memory-and-lessons.md`](memory-and-lessons.md)
